...
0. **4/21(화) 19:05 daily_change_scan_alert 첫 발송 확인** — 새 프리셋 3종(turnaround/fscore_jump/insider_cluster_buy) + 매일 19:05 평일 텔레그램 발송. 워치/포트 제외 + 7일 쿨다운. fscore_jump는 ~7/15 이후 정상 작동(히스토리 90d 필요).
