...
| 2026-04-19 | 거버넌스 2단계 (특별/주식배당 감지) | `_GOVERNANCE_KEYWORDS` 에 "특별배당"+"주식배당" 추가. 정기 "현금배당"/"중간배당"은 제외(분기마다 대량 발생 노이즈). 타입 순서 재조정: 소각>특별배당>주식배당>취득>처분>기타. 아이콘 💰🎁. 7일치 매치 0건(연말/분기 시즌 외 정상). 3단계 Value-Up 지수 편입은 후속. |
