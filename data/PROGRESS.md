...
0e. **4/21(화) 19:10 daily_governance_alert 첫 발송 확인** — 자사주 취득/소각/처분 전종목 스캔 (4/19, dd1c77c). 30일 쿨다운 `governance_sent.json`. 일평균 0~2건 예상, 자사주 시즌에 빈도 증가. 워치/포트 교집합은 👀 표시.
...
| 2026-04-19 | 거버넌스/밸류업 1단계 (자사주 감지) | `filter_governance_disclosures` + `daily_governance_alert` 매일 19:10 평일. 키워드 14종(자기주식/자사주 × 취득/소각/처분/매입). 전종목 DART 공시 스캔 → rcept_no 기반 30일 쿨다운. 유형별 그룹(소각>취득>처분>기타), 타입당 10건 상한. 워치/포트 👀 플래그. 스모크: 7일치 2건(더블유게임즈/크레버스 처분). |
| 2026-04-19 | 거버넌스 2단계 (특별/주식배당 감지) | `_GOVERNANCE_KEYWORDS` 에 "특별배당"+"주식배당" 추가. 정기 "현금배당"/"중간배당"은 제외(분기마다 대량 발생 노이즈). 타입 순서 재조정: 소각>특별배당>주식배당>취득>처분>기타. 아이콘 💰🎁. 7일치 매치 0건(연말/분기 시즌 외 정상). |
| 2026-04-19 | 거버넌스 3단계 (밸류업 공시 감지) | `_GOVERNANCE_KEYWORDS` 에 "기업가치제고"/"기업가치 제고" 추가 (DART 자율공시 제목 패턴). 태그 "밸류업" 신규, 아이콘 💎. 30일 실측 2건 (한국경제TV/바이오비쥬). KRX 밸류업 지수 편입 후보 발굴 + 장기 주주환원 약속 → PER 재평가 트리거. |
