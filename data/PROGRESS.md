...
3. **🟢 5/10 (일) 07:15 KST `weekly_financial` 60분 타임아웃 검증** — 30→60분 상향 후 처음. IS/BS/DART 카운트 dict 알림 도착 확인.
...
### 🎯 5/5 커밋: 7건 (5c88061 → c9b6004), main.py + krx_crawler.py + thesis/AMD.md
...
| 2026-05-05 | load_krx_db shadow 버그 + 운영 안정화 (5c88061~c9b6004, 7커밋) | krx_crawler.py L17 try-import 후 L511 def 재정의 → main.py 3곳이 4/7 JSON 보던 사고. _USE_SQLITE 가드로 fix. 동일 패턴 _load_history/scan_stocks 도 export alias 가드. 부수: weekly_us_analyst_sync KeyError, weekly_sanity 휴장일, watch_change 임계값 강화, AMD watchalert 정리. |
