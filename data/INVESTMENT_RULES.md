...
**v2 보강 (2026-05-14, 한국 시장 특수성 반영)** ⚠️ — 사용자 실증 학습:
- v1은 한국 셀사이드 매수 93.1% 환경에서 발동 한계. 효성중공업/HD현대일렉/LS ELECTRIC 1년 +194~490% 폭등 시점(2026-05-07)에도 v1 3/3 미충족. 시장이 -15% 자율조정으로 자동 처리.
- **v2 보조 조건 (4개 중 3개 충족 시 부분 정리 검토)**:
  1. Fwd PER > 업종 5년 평균 × 2 OR 역사 상단 근접
  2. **누적 급등: 3주 +30% OR 1년 +200%** (누적 폭등 보강 — 핵심 변경점)
  3. 컨센 상향 클러스터 (4주 내 5건+ TP 상향)
  4. 외인 보유 비중 > 5년 평균 + 5%p (한국 리밸런싱 압력)
- 발동 시: 부분 정리 1/3 (단일 비중 25%↑), 1/2 (단일 비중 30%↑)
- **한계 인지**: 정점 발견 후행성 본질적. 시장 자율조정 -10% 이상 진행 시 트리거 무효 처리 (이미 시장이 처리함), 다음 catalyst 사이클 대기.
- v2 추가 근거: 한국 외국인 보유 39%대 (2006년 이후 최고치, 자본시장연구원 김준석 2026) → 단기 리밸런싱 트리거. Choe-Kho-Stulz (1999) JFE 54(2) destabilize 가설 부정 단서로 단독 트리거는 금지, 보조 시그널.
...
| 항목 | 기존 | 변경 |
|---|---|---|
| T3 유포리아 조건 2 | "3주 +30%" 단독 | "3주 +30% OR 1년 +200%" 누적 보강 (v2) |
| T3 v2 보조 조건 추가 | 없음 | 외인 보유 5년 평균 +5%p 초과 (Choe-Kho-Stulz 1999 보조 시그널) |
| T3 한계 명시 추가 | 없음 | 시장 자율조정 -10%↑ 진행 시 트리거 무효 (정점 발견 후행성) |
| T2 가이드 하향 우선 | 컨센·가이드 동등 | **회사 직접 가이드 하향 > 셀사이드 컨센** (KCMI 2026 한국 TP 정보가치 소멸) |
