...
**완화된 thesis 손상**: EPS 컨센서스 30일 -10% 이상 하향 + TP 하향 리포트 비중 >50% → 부분 비중 축소(50%) 검토. 단독으로 전량 청산 불가(Devil's Advocate 통과 필수). (※ 한국은 애널 다운그레이드 자체가 드물어(변경률 2.5%) 이 신호의 발생 빈도가 낮음 — 보조로만.)
