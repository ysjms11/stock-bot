...
### 인프라
- [ ] **🆕 한국 리포트 PDF 입수 경로 확장** — 와이즈리포트 미수집 1,990건 (KB 182 / 한투 164 / 삼성 149 / 신한 138 / NH 134 / 다올 122 / 메리츠 90 ...). 3옵션 중 결정 필요:
  - **A 무료 영구**: 메리츠/키움/유안타 쿠키 + 한경 + 무로그인 소형 → 회수율 50~60%, 셋업 15분 후 0
  - **B 무료 월10분**: A + 한투/KB/삼성 쿠키 (인증서 broker 2~4주 만료 알림+재export) → 회수율 80~90%
  - **C 유료**: 와이즈리포트 구독 (월 20~30만) → 100% + 신규 자동, 너 작업 0
  - 결정 후 broker별 스크래퍼 + 쿠키 keep-alive ping + 텔레그램 만료 알림 구현
