...
- [x] **관세청 10일 수출** — 2026-04-23 Phase 1~2 완성. data.go.kr Open API 3개 엔드포인트(Itemtrade/nitemtrade/nationtrade). 30종목 × 75 HS 매핑 (`hs_ticker_map.json`). MCP `get_export_trend` 4 modes. 월 3회 자동 알림 (11일/21일/16일) + korea.kr PDF 파싱. **다음**: Phase 3 test-writer/reviewer + 5월 첫 발송 검증. 알파 3개월 관찰 모드.
